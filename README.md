# Setting Up the RoomEase Booking App

This guide will walk you through the process of setting up the RoomEase Booking App on your local machine.
...
```bash
git clone https://github.com/BramhamChowdary48/RoomEase.git
cd mern-booking-app
```
